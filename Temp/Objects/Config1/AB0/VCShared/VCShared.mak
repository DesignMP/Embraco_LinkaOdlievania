...
VCUG_SOURCES_Visu=$(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Length.vcug \
	...
	$(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Tlak.vcug \
	$(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Dlzka.vcug \
	$(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Otacky.vcug 
...
$(AS_CPU_PATH)/VCShared/vcug.Tlak.vco: $(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Tlak.vcug
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4726 -sfas


$(AS_CPU_PATH)/VCShared/vcug.Dlzka.vco: $(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Dlzka.vcug
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4726 -sfas


$(AS_CPU_PATH)/VCShared/vcug.Otacky.vco: $(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Otacky.vcug
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4726 -sfas
